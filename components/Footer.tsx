      ...
      <div className="w-full px-4 bg-bisyou-default py-10">
        <div className="w-full mx-auto max-w-bisyouContainer max-sm:gap-5 flex flex-col md:flex-row justify-between">
          <div className="flex flex-col gap-10">
            <Image src={logo} width={150} height={60} alt="logo-bisyou" />
              ...
              {pages.map((p) => (
                <li key={`page-` + p.id}>
                  <a
                    ...
                    href={`pages/${p.slug}`}
                    aria-label={p.description ? p.description : ""}
                  >
                    {p.title}
                  </a>
                </li>
          ...
          <div className="flex flex-col gap-7 max-w-[300px] text-bisyou-font">
            <h2 className="text-2xl font-normal text-bisyou-font">Skin news</h2>

            <span>
              Fique por dentro das novidades da BisYou e receba dicas de
              skincare
            </span>
          ...
          <div className="flex flex-col gap-10 text-bisyou-font">
            <h2 className="text-2xl font-normal">Segue a gente lá</h2>
        ...
        <div className="w-full mx-auto max-w-bisyouContainer max-sm:gap-5 mt-4 pt-4 border-t text-bisyou-font border-bisyou-font flex flex-col md:flex-row justify-start md:justify-between xl:items-center">
