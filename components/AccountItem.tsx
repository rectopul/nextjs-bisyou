...
export function AccountItem({ user }: AccountItemProps) {
    ...
    return (
        <>
            <AlertDialog>
                <AlertDialogTrigger className="font-sans flex items-center gap-2 text-xs p-3 rounded-lg font-bold text-center text-blue-gray-500 hover:bg-blue-gray-500/10">
                    <svg
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            Alterar usuário {user.name}
                        </AlertDialogTitle>
                        <AlertDialogDescription>
                            Utilize o formulário abaixo para alterar informações
                            do usuário.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
